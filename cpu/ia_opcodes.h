...
bx_define_opcode(BX_IA_ADC_EAXId, &BX_CPU_C::ADC_EAXId, NULL, BX_CPU_386)
...
bx_define_opcode(BX_IA_ADC_EdGdM, &BX_CPU_C::ADC_EdGdM, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_ADC_EdIdM, &BX_CPU_C::ADC_EdIdM, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_ADC_EdIdR, &BX_CPU_C::ADC_EdIdR, NULL, BX_CPU_386)
...
bx_define_opcode(BX_IA_ADC_GdEdM, &BX_CPU_C::LOAD_Ed, &BX_CPU_C::ADC_GdEdR, BX_CPU_386)
bx_define_opcode(BX_IA_ADC_GdEdR, &BX_CPU_C::ADC_GdEdR, NULL, BX_CPU_386)
...
bx_define_opcode(BX_IA_ADD_EAXId, &BX_CPU_C::ADD_EAXId, NULL, BX_CPU_386)
...
bx_define_opcode(BX_IA_ADD_EdGdM, &BX_CPU_C::ADD_EdGdM, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_ADD_EdIdM, &BX_CPU_C::ADD_EdIdM, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_ADD_EdIdR, &BX_CPU_C::ADD_EdIdR, NULL, BX_CPU_386)
...
bx_define_opcode(BX_IA_ADD_GdEdM, &BX_CPU_C::LOAD_Ed, &BX_CPU_C::ADD_GdEdR, BX_CPU_386)
bx_define_opcode(BX_IA_ADD_GdEdR, &BX_CPU_C::ADD_GdEdR, NULL, BX_CPU_386)
...
bx_define_opcode(BX_IA_AND_EAXId, &BX_CPU_C::AND_EAXId, NULL, BX_CPU_386)
...
bx_define_opcode(BX_IA_AND_EdGdM, &BX_CPU_C::AND_EdGdM, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_AND_EdIdM, &BX_CPU_C::AND_EdIdM, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_AND_EdIdR, &BX_CPU_C::AND_EdIdR, NULL, BX_CPU_386)
...
bx_define_opcode(BX_IA_AND_GdEdM, &BX_CPU_C::LOAD_Ed, &BX_CPU_C::AND_GdEdR, BX_CPU_386)
bx_define_opcode(BX_IA_AND_GdEdR, &BX_CPU_C::AND_GdEdR, NULL, BX_CPU_386)
...
bx_define_opcode(BX_IA_ARPL_EwGw, &BX_CPU_C::ARPL_EwGw, NULL, BX_CPU_286)
bx_define_opcode(BX_IA_BOUND_GdMa, &BX_CPU_C::BOUND_GdMa, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_BOUND_GwMa, &BX_CPU_C::BOUND_GwMa, NULL, BX_CPU_80186)
bx_define_opcode(BX_IA_BSF_GdEdR, &BX_CPU_C::BSF_GdEdR, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_BSF_GdEdM, &BX_CPU_C::LOAD_Ed, &BX_CPU_C::BSF_GdEdR, BX_CPU_386)
bx_define_opcode(BX_IA_BSF_GwEwR, &BX_CPU_C::BSF_GwEwR, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_BSF_GwEwM, &BX_CPU_C::LOAD_Ew, &BX_CPU_C::BSF_GwEwR, BX_CPU_386)
bx_define_opcode(BX_IA_BSR_GdEdR, &BX_CPU_C::BSR_GdEdR, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_BSR_GdEdM, &BX_CPU_C::LOAD_Ed, &BX_CPU_C::BSR_GdEdR, BX_CPU_386)
bx_define_opcode(BX_IA_BSR_GwEwR, &BX_CPU_C::BSR_GwEwR, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_BSR_GwEwM, &BX_CPU_C::LOAD_Ew, &BX_CPU_C::BSR_GwEwR, BX_CPU_386)
bx_define_opcode(BX_IA_BT_EdGdM, &BX_CPU_C::BT_EdGdM, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_BT_EdGdR, &BX_CPU_C::BT_EdGdR, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_BT_EdIbM, &BX_CPU_C::BT_EdIbM, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_BT_EdIbR, &BX_CPU_C::BT_EdIbR, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_BT_EwGwM, &BX_CPU_C::BT_EwGwM, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_BT_EwGwR, &BX_CPU_C::BT_EwGwR, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_BT_EwIbM, &BX_CPU_C::BT_EwIbM, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_BT_EwIbR, &BX_CPU_C::BT_EwIbR, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_BTC_EdGdM, &BX_CPU_C::BTC_EdGdM, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_BTC_EdGdR, &BX_CPU_C::BTC_EdGdR, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_BTC_EdIbM, &BX_CPU_C::BTC_EdIbM, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_BTC_EdIbR, &BX_CPU_C::BTC_EdIbR, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_BTC_EwGwM, &BX_CPU_C::BTC_EwGwM, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_BTC_EwGwR, &BX_CPU_C::BTC_EwGwR, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_BTC_EwIbM, &BX_CPU_C::BTC_EwIbM, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_BTC_EwIbR, &BX_CPU_C::BTC_EwIbR, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_BTR_EdGdM, &BX_CPU_C::BTR_EdGdM, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_BTR_EdGdR, &BX_CPU_C::BTR_EdGdR, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_BTR_EdIbM, &BX_CPU_C::BTR_EdIbM, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_BTR_EdIbR, &BX_CPU_C::BTR_EdIbR, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_BTR_EwGwM, &BX_CPU_C::BTR_EwGwM, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_BTR_EwGwR, &BX_CPU_C::BTR_EwGwR, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_BTR_EwIbM, &BX_CPU_C::BTR_EwIbM, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_BTR_EwIbR, &BX_CPU_C::BTR_EwIbR, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_BTS_EdGdM, &BX_CPU_C::BTS_EdGdM, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_BTS_EdGdR, &BX_CPU_C::BTS_EdGdR, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_BTS_EdIbM, &BX_CPU_C::BTS_EdIbM, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_BTS_EdIbR, &BX_CPU_C::BTS_EdIbR, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_BTS_EwGwM, &BX_CPU_C::BTS_EwGwM, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_BTS_EwGwR, &BX_CPU_C::BTS_EwGwR, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_BTS_EwIbM, &BX_CPU_C::BTS_EwIbM, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_BTS_EwIbR, &BX_CPU_C::BTS_EwIbR, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_CALL_EdM, &BX_CPU_C::LOAD_Ed, &BX_CPU_C::CALL_EdR, BX_CPU_386)
bx_define_opcode(BX_IA_CALL_EdR, &BX_CPU_C::CALL_EdR, NULL, BX_CPU_386)
...
bx_define_opcode(BX_IA_CALL_Jd, &BX_CPU_C::CALL_Jd, NULL, BX_CPU_386)
...
bx_define_opcode(BX_IA_CALL32_Ap, &BX_CPU_C::CALL32_Ap, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_CALL32_Ep, &BX_CPU_C::CALL32_Ep, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_CBW, &BX_CPU_C::CBW, NULL, 0)
bx_define_opcode(BX_IA_CDQ, &BX_CPU_C::CDQ, NULL, BX_CPU_386)
...
bx_define_opcode(BX_IA_CLTS, &BX_CPU_C::CLTS, NULL, BX_CPU_286)
...
bx_define_opcode(BX_IA_CMP_EAXId, &BX_CPU_C::CMP_EAXId, NULL, BX_CPU_386)
...
bx_define_opcode(BX_IA_CMP_EdGdM, &BX_CPU_C::CMP_EdGdM, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_CMP_EdIdM, &BX_CPU_C::CMP_EdIdM, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_CMP_EdIdR, &BX_CPU_C::CMP_EdIdR, NULL, BX_CPU_386)
...
bx_define_opcode(BX_IA_CMP_GdEdM, &BX_CPU_C::LOAD_Ed, &BX_CPU_C::CMP_GdEdR, BX_CPU_386)
bx_define_opcode(BX_IA_CMP_GdEdR, &BX_CPU_C::CMP_GdEdR, NULL, BX_CPU_386)
...
bx_define_opcode(BX_IA_CMPXCHG_IBTS, &BX_CPU_C::CMPXCHG_IBTS, NULL, BX_CPU_486)
bx_define_opcode(BX_IA_CMPXCHG_XBTS, &BX_CPU_C::CMPXCHG_XBTS, NULL, BX_CPU_486)
bx_define_opcode(BX_IA_CWD, &BX_CPU_C::CWD, NULL, 0)
bx_define_opcode(BX_IA_CWDE, &BX_CPU_C::CWDE, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_DEC_EbM, &BX_CPU_C::DEC_EbM, NULL, 0)
bx_define_opcode(BX_IA_DEC_EbR, &BX_CPU_C::DEC_EbR, NULL, 0)
bx_define_opcode(BX_IA_DEC_EdR, &BX_CPU_C::DEC_ERX, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_DEC_EdM, &BX_CPU_C::DEC_EdM, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_DEC_ERX, &BX_CPU_C::DEC_ERX, NULL, BX_CPU_386)
...
bx_define_opcode(BX_IA_DIV_EAXEdR, &BX_CPU_C::DIV_EAXEdR, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_DIV_EAXEdM, &BX_CPU_C::LOAD_Ed, &BX_CPU_C::DIV_EAXEdR, BX_CPU_386)
bx_define_opcode(BX_IA_ENTER16_IwIb, &BX_CPU_C::ENTER16_IwIb, NULL, BX_CPU_80186)
bx_define_opcode(BX_IA_ENTER32_IwIb, &BX_CPU_C::ENTER32_IwIb, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_HLT, &BX_CPU_C::HLT, NULL, BX_CPU_386)
...
bx_define_opcode(BX_IA_IDIV_EAXEdR, &BX_CPU_C::IDIV_EAXEdR, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_IDIV_EAXEdM, &BX_CPU_C::LOAD_Ed, &BX_CPU_C::IDIV_EAXEdR, BX_CPU_386)
...
bx_define_opcode(BX_IA_IMUL_EAXEdR, &BX_CPU_C::IMUL_EAXEdR, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_IMUL_EAXEdM, &BX_CPU_C::LOAD_Ed, &BX_CPU_C::IMUL_EAXEdR, BX_CPU_386)
bx_define_opcode(BX_IA_IMUL_GdEdR, &BX_CPU_C::IMUL_GdEdR, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_IMUL_GdEdM, &BX_CPU_C::LOAD_Ed, &BX_CPU_C::IMUL_GdEdR, BX_CPU_386)
bx_define_opcode(BX_IA_IMUL_GdEdIdR, &BX_CPU_C::IMUL_GdEdIdR, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_IMUL_GdEdIdM, &BX_CPU_C::LOAD_Ed, &BX_CPU_C::IMUL_GdEdIdR, BX_CPU_386)
...
bx_define_opcode(BX_IA_IMUL_GwEwIwR, &BX_CPU_C::IMUL_GwEwIwR, NULL, BX_CPU_80186)
bx_define_opcode(BX_IA_IMUL_GwEwIwM, &BX_CPU_C::LOAD_Ew, &BX_CPU_C::IMUL_GwEwIwR, BX_CPU_80186)
...
bx_define_opcode(BX_IA_IN_EAXDX, &BX_CPU_C::IN_EAXDX, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_IN_EAXIb, &BX_CPU_C::IN_EAXIb, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_INC_EbM, &BX_CPU_C::INC_EbM, NULL, 0)
bx_define_opcode(BX_IA_INC_EbR, &BX_CPU_C::INC_EbR, NULL, 0)
bx_define_opcode(BX_IA_INC_EdR, &BX_CPU_C::INC_ERX, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_INC_EdM, &BX_CPU_C::INC_EdM, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_INC_ERX, &BX_CPU_C::INC_ERX, NULL, BX_CPU_386)
...
bx_define_opcode(BX_IA_IRET32, &BX_CPU_C::IRET32, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_JB_Jd, &BX_CPU_C::JB_Jd, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_JB_Jw, &BX_CPU_C::JB_Jw, NULL, 0)
bx_define_opcode(BX_IA_JBE_Jd, &BX_CPU_C::JBE_Jd, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_JBE_Jw, &BX_CPU_C::JBE_Jw, NULL, 0)
bx_define_opcode(BX_IA_JCXZ_Jb, &BX_CPU_C::JCXZ_Jb, NULL, 0)
bx_define_opcode(BX_IA_JECXZ_Jb, &BX_CPU_C::JECXZ_Jb, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_JL_Jd, &BX_CPU_C::JL_Jd, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_JL_Jw, &BX_CPU_C::JL_Jw, NULL, 0)
bx_define_opcode(BX_IA_JLE_Jd, &BX_CPU_C::JLE_Jd, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_JLE_Jw, &BX_CPU_C::JLE_Jw, NULL, 0)
bx_define_opcode(BX_IA_JMP_Ap, &BX_CPU_C::JMP_Ap, NULL, 0)
bx_define_opcode(BX_IA_JMP_EdM, &BX_CPU_C::LOAD_Ed, &BX_CPU_C::JMP_EdR, BX_CPU_386)
bx_define_opcode(BX_IA_JMP_EdR, &BX_CPU_C::JMP_EdR, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_JMP_EwM, &BX_CPU_C::LOAD_Ew, &BX_CPU_C::JMP_EwR, 0)
bx_define_opcode(BX_IA_JMP_EwR, &BX_CPU_C::JMP_EwR, NULL, 0)
bx_define_opcode(BX_IA_JMP_Jd, &BX_CPU_C::JMP_Jd, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_JMP_Jw, &BX_CPU_C::JMP_Jw, NULL, 0)
bx_define_opcode(BX_IA_JMP16_Ep, &BX_CPU_C::JMP16_Ep, NULL, 0)
bx_define_opcode(BX_IA_JMP32_Ep, &BX_CPU_C::JMP32_Ep, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_JNB_Jd, &BX_CPU_C::JNB_Jd, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_JNB_Jw, &BX_CPU_C::JNB_Jw, NULL, 0)
bx_define_opcode(BX_IA_JNBE_Jd, &BX_CPU_C::JNBE_Jd, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_JNBE_Jw, &BX_CPU_C::JNBE_Jw, NULL, 0)
bx_define_opcode(BX_IA_JNL_Jd, &BX_CPU_C::JNL_Jd, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_JNL_Jw, &BX_CPU_C::JNL_Jw, NULL, 0)
bx_define_opcode(BX_IA_JNLE_Jd, &BX_CPU_C::JNLE_Jd, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_JNLE_Jw, &BX_CPU_C::JNLE_Jw, NULL, 0)
bx_define_opcode(BX_IA_JNO_Jd, &BX_CPU_C::JNO_Jd, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_JNO_Jw, &BX_CPU_C::JNO_Jw, NULL, 0)
bx_define_opcode(BX_IA_JNP_Jd, &BX_CPU_C::JNP_Jd, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_JNP_Jw, &BX_CPU_C::JNP_Jw, NULL, 0)
bx_define_opcode(BX_IA_JNS_Jd, &BX_CPU_C::JNS_Jd, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_JNS_Jw, &BX_CPU_C::JNS_Jw, NULL, 0)
bx_define_opcode(BX_IA_JNZ_Jd, &BX_CPU_C::JNZ_Jd, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_JNZ_Jw, &BX_CPU_C::JNZ_Jw, NULL, 0)
bx_define_opcode(BX_IA_JO_Jd, &BX_CPU_C::JO_Jd, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_JO_Jw, &BX_CPU_C::JO_Jw, NULL, 0)
bx_define_opcode(BX_IA_JP_Jd, &BX_CPU_C::JP_Jd, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_JP_Jw, &BX_CPU_C::JP_Jw, NULL, 0)
bx_define_opcode(BX_IA_JS_Jd, &BX_CPU_C::JS_Jd, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_JS_Jw, &BX_CPU_C::JS_Jw, NULL, 0)
bx_define_opcode(BX_IA_JZ_Jd, &BX_CPU_C::JZ_Jd, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_JZ_Jw, &BX_CPU_C::JZ_Jw, NULL, 0)
bx_define_opcode(BX_IA_LAHF, &BX_CPU_C::LAHF, NULL, 0)
bx_define_opcode(BX_IA_LAR_GvEw, &BX_CPU_C::LAR_GvEw, NULL, BX_CPU_286)
bx_define_opcode(BX_IA_LDS_GdMp, &BX_CPU_C::LDS_GdMp, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_LDS_GwMp, &BX_CPU_C::LDS_GwMp, NULL, 0)
bx_define_opcode(BX_IA_LEA_GdM, &BX_CPU_C::LEA_GdM, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_LEA_GwM, &BX_CPU_C::LEA_GwM, NULL, 0)
bx_define_opcode(BX_IA_LEAVE16, &BX_CPU_C::LEAVE16, NULL, BX_CPU_80186)
bx_define_opcode(BX_IA_LEAVE32, &BX_CPU_C::LEAVE32, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_LES_GdMp, &BX_CPU_C::LES_GdMp, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_LES_GwMp, &BX_CPU_C::LES_GwMp, NULL, 0)
bx_define_opcode(BX_IA_LFS_GdMp, &BX_CPU_C::LFS_GdMp, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_LFS_GwMp, &BX_CPU_C::LFS_GwMp, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_LGDT_Ms, &BX_CPU_C::LGDT_Ms, NULL, BX_CPU_286)
bx_define_opcode(BX_IA_LGS_GdMp, &BX_CPU_C::LGS_GdMp, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_LGS_GwMp, &BX_CPU_C::LGS_GwMp, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_LIDT_Ms, &BX_CPU_C::LIDT_Ms, NULL, BX_CPU_286)
bx_define_opcode(BX_IA_LLDT_Ew, &BX_CPU_C::LLDT_Ew, NULL, BX_CPU_286)
bx_define_opcode(BX_IA_LMSW_Ew, &BX_CPU_C::LMSW_Ew, NULL, BX_CPU_286)
...
bx_define_opcode(BX_IA_LOOP32_Jb, &BX_CPU_C::LOOP32_Jb, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_LOOPE32_Jb, &BX_CPU_C::LOOPE32_Jb, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_LOOPNE32_Jb, &BX_CPU_C::LOOPNE32_Jb, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_LSL_GvEw, &BX_CPU_C::LSL_GvEw, NULL, BX_CPU_286)
bx_define_opcode(BX_IA_LSS_GdMp, &BX_CPU_C::LSS_GdMp, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_LSS_GwMp, &BX_CPU_C::LSS_GwMp, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_LTR_Ew, &BX_CPU_C::LTR_Ew, NULL, BX_CPU_286)
bx_define_opcode(BX_IA_MOV_ALOd, &BX_CPU_C::MOV_ALOd, NULL, 0)
bx_define_opcode(BX_IA_MOV_AXOd, &BX_CPU_C::MOV_AXOd, NULL, 0)
bx_define_opcode(BX_IA_MOV_CdRd, &BX_CPU_C::MOV_CdRd, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_MOV_DdRd, &BX_CPU_C::MOV_DdRd, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_MOV_EAXOd, &BX_CPU_C::MOV_EAXOd, NULL, BX_CPU_386)
...
bx_define_opcode(BX_IA_MOV_EdIdM, &BX_CPU_C::MOV_EdIdM, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_MOV_EdIdR, &BX_CPU_C::MOV_ERXId, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_MOV_ERXId, &BX_CPU_C::MOV_ERXId, NULL, BX_CPU_386)
...
bx_define_opcode(BX_IA_MOV32_EdGdM, &BX_CPU_C::MOV32_EdGdM, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_MOV32_GdEdM, &BX_CPU_C::MOV32_GdEdM, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_MOV_GdEdR, &BX_CPU_C::MOV_GdEdR, NULL, BX_CPU_386)
...
bx_define_opcode(BX_IA_MOV_OdEAX, &BX_CPU_C::MOV_OdEAX, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_MOV_RdCd, &BX_CPU_C::MOV_RdCd, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_MOV_RdDd, &BX_CPU_C::MOV_RdDd, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_MOV_RdTd, &BX_CPU_C::MOV_RdTd, NULL, BX_CPU_386)
...
bx_define_opcode(BX_IA_MOV_TdRd, &BX_CPU_C::MOV_TdRd, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_MOVSX_GdEbM, &BX_CPU_C::MOVSX_GdEbM, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_MOVSX_GdEbR, &BX_CPU_C::MOVSX_GdEbR, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_MOVSX_GdEwM, &BX_CPU_C::MOVSX_GdEwM, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_MOVSX_GdEwR, &BX_CPU_C::MOVSX_GdEwR, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_MOVSX_GwEbM, &BX_CPU_C::MOVSX_GwEbM, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_MOVSX_GwEbR, &BX_CPU_C::MOVSX_GwEbR, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_MOVZX_GdEbM, &BX_CPU_C::MOVZX_GdEbM, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_MOVZX_GdEbR, &BX_CPU_C::MOVZX_GdEbR, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_MOVZX_GdEwM, &BX_CPU_C::MOVZX_GdEwM, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_MOVZX_GdEwR, &BX_CPU_C::MOVZX_GdEwR, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_MOVZX_GwEbM, &BX_CPU_C::MOVZX_GwEbM, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_MOVZX_GwEbR, &BX_CPU_C::MOVZX_GwEbR, NULL, BX_CPU_386)
...
bx_define_opcode(BX_IA_MUL_EAXEdR, &BX_CPU_C::MUL_EAXEdR, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_MUL_EAXEdM, &BX_CPU_C::LOAD_Ed, &BX_CPU_C::MUL_EAXEdR, BX_CPU_386)
bx_define_opcode(BX_IA_NEG_EbM, &BX_CPU_C::NEG_EbM, NULL, 0)
bx_define_opcode(BX_IA_NEG_EbR, &BX_CPU_C::NEG_EbR, NULL, 0)
bx_define_opcode(BX_IA_NEG_EdM, &BX_CPU_C::NEG_EdM, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_NEG_EdR, &BX_CPU_C::NEG_EdR, NULL, BX_CPU_386)
...
bx_define_opcode(BX_IA_PAUSE, &BX_CPU_C::PAUSE, NULL, BX_CPU_P6)
bx_define_opcode(BX_IA_NOT_EbM, &BX_CPU_C::NOT_EbM, NULL, 0)
bx_define_opcode(BX_IA_NOT_EbR, &BX_CPU_C::NOT_EbR, NULL, 0)
bx_define_opcode(BX_IA_NOT_EdM, &BX_CPU_C::NOT_EdM, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_NOT_EdR, &BX_CPU_C::NOT_EdR, NULL, BX_CPU_386)
...
bx_define_opcode(BX_IA_OR_EAXId, &BX_CPU_C::OR_EAXId, NULL, BX_CPU_386)
...
bx_define_opcode(BX_IA_OR_EdGdM, &BX_CPU_C::OR_EdGdM, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_OR_EdIdM, &BX_CPU_C::OR_EdIdM, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_OR_EdIdR, &BX_CPU_C::OR_EdIdR, NULL, BX_CPU_386)
...
bx_define_opcode(BX_IA_OR_GdEdM, &BX_CPU_C::LOAD_Ed, &BX_CPU_C::OR_GdEdR, BX_CPU_386)
bx_define_opcode(BX_IA_OR_GdEdR, &BX_CPU_C::OR_GdEdR, NULL, BX_CPU_386)
...
bx_define_opcode(BX_IA_OUT_DXEAX, &BX_CPU_C::OUT_DXEAX, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_OUT_IbAL, &BX_CPU_C::OUT_IbAL, NULL, 0)
bx_define_opcode(BX_IA_OUT_IbAX, &BX_CPU_C::OUT_IbAX, NULL, 0)
bx_define_opcode(BX_IA_OUT_IbEAX, &BX_CPU_C::OUT_IbEAX, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_POP_EdM, &BX_CPU_C::POP_EdM, NULL, 0)
bx_define_opcode(BX_IA_POP_EdR, &BX_CPU_C::POP_ERX, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_POP_ERX, &BX_CPU_C::POP_ERX, NULL, BX_CPU_386)
...
bx_define_opcode(BX_IA_POP16_FS, &BX_CPU_C::POP16_FS, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_POP16_GS, &BX_CPU_C::POP16_GS, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_POP16_SS, &BX_CPU_C::POP16_SS, NULL, 0)
bx_define_opcode(BX_IA_POP32_DS, &BX_CPU_C::POP32_DS, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_POP32_ES, &BX_CPU_C::POP32_ES, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_POP32_FS, &BX_CPU_C::POP32_FS, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_POP32_GS, &BX_CPU_C::POP32_GS, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_POP32_SS, &BX_CPU_C::POP32_SS, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_POPAD16, &BX_CPU_C::POPAD16, NULL, BX_CPU_80186)
bx_define_opcode(BX_IA_POPAD32, &BX_CPU_C::POPAD32, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_POPF_Fd, &BX_CPU_C::POPF_Fd, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_POPF_Fw, &BX_CPU_C::POPF_Fw, NULL, 0)
bx_define_opcode(BX_IA_PUSH_EdM, &BX_CPU_C::PUSH_EdM, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_PUSH_EdR, &BX_CPU_C::PUSH_ERX, NULL, BX_CPU_386)
...
bx_define_opcode(BX_IA_PUSH_Id, &BX_CPU_C::PUSH_Id, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_PUSH_Iw, &BX_CPU_C::PUSH_Iw, NULL, BX_CPU_80186)
...
bx_define_opcode(BX_IA_PUSH16_FS, &BX_CPU_C::PUSH16_FS, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_PUSH16_GS, &BX_CPU_C::PUSH16_GS, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_PUSH16_SS, &BX_CPU_C::PUSH16_SS, NULL, 0)
bx_define_opcode(BX_IA_PUSH32_CS, &BX_CPU_C::PUSH32_CS, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_PUSH32_DS, &BX_CPU_C::PUSH32_DS, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_PUSH32_ES, &BX_CPU_C::PUSH32_ES, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_PUSH32_FS, &BX_CPU_C::PUSH32_FS, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_PUSH32_GS, &BX_CPU_C::PUSH32_GS, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_PUSH32_SS, &BX_CPU_C::PUSH32_SS, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_PUSHAD16, &BX_CPU_C::PUSHAD16, NULL, BX_CPU_80186)
bx_define_opcode(BX_IA_PUSHAD32, &BX_CPU_C::PUSHAD32, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_PUSHF_Fd, &BX_CPU_C::PUSHF_Fd, NULL, BX_CPU_386)
...
bx_define_opcode(BX_IA_REP_CMPSD_XdYd, &BX_CPU_C::REP_CMPSD_XdYd, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_REP_CMPSW_XwYw, &BX_CPU_C::REP_CMPSW_XwYw, NULL, 0)
bx_define_opcode(BX_IA_REP_INSB_YbDX, &BX_CPU_C::REP_INSB_YbDX, NULL, BX_CPU_80186)
bx_define_opcode(BX_IA_REP_INSD_YdDX, &BX_CPU_C::REP_INSD_YdDX, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_REP_INSW_YwDX, &BX_CPU_C::REP_INSW_YwDX, NULL, BX_CPU_80186)
bx_define_opcode(BX_IA_REP_LODSB_ALXb, &BX_CPU_C::REP_LODSB_ALXb, NULL, 0)
bx_define_opcode(BX_IA_REP_LODSD_EAXXd, &BX_CPU_C::REP_LODSD_EAXXd, NULL, BX_CPU_386)
...
bx_define_opcode(BX_IA_REP_MOVSD_XdYd, &BX_CPU_C::REP_MOVSD_XdYd, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_REP_MOVSW_XwYw, &BX_CPU_C::REP_MOVSW_XwYw, NULL, 0)
bx_define_opcode(BX_IA_REP_OUTSB_DXXb, &BX_CPU_C::REP_OUTSB_DXXb, NULL, BX_CPU_80186)
bx_define_opcode(BX_IA_REP_OUTSD_DXXd, &BX_CPU_C::REP_OUTSD_DXXd, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_REP_OUTSW_DXXw, &BX_CPU_C::REP_OUTSW_DXXw, NULL, BX_CPU_80186)
bx_define_opcode(BX_IA_REP_SCASB_ALXb, &BX_CPU_C::REP_SCASB_ALXb, NULL, 0)
bx_define_opcode(BX_IA_REP_SCASD_EAXXd, &BX_CPU_C::REP_SCASD_EAXXd, NULL, BX_CPU_386)
...
bx_define_opcode(BX_IA_REP_STOSD_YdEAX, &BX_CPU_C::REP_STOSD_YdEAX, NULL, BX_CPU_386)
...
bx_define_opcode(BX_IA_RETfar32, &BX_CPU_C::RETfar32, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_RETfar32_Iw, &BX_CPU_C::RETfar32_Iw, NULL, BX_CPU_386)
...
bx_define_opcode(BX_IA_RETnear32, &BX_CPU_C::RETnear32, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_RETnear32_Iw, &BX_CPU_C::RETnear32_Iw, NULL, BX_CPU_386)
...
bx_define_opcode(BX_IA_RCR_EdM, &BX_CPU_C::RCR_EdM, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_RCL_EdM, &BX_CPU_C::RCL_EdM, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_ROL_EdM, &BX_CPU_C::ROL_EdM, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_ROR_EdM, &BX_CPU_C::ROR_EdM, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_SAR_EdM, &BX_CPU_C::SAR_EdM, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_SHL_EdM, &BX_CPU_C::SHL_EdM, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_SHR_EdM, &BX_CPU_C::SHR_EdM, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_RCR_EdR, &BX_CPU_C::RCR_EdR, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_RCL_EdR, &BX_CPU_C::RCL_EdR, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_ROL_EdR, &BX_CPU_C::ROL_EdR, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_ROR_EdR, &BX_CPU_C::ROR_EdR, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_SAR_EdR, &BX_CPU_C::SAR_EdR, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_SHL_EdR, &BX_CPU_C::SHL_EdR, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_SHR_EdR, &BX_CPU_C::SHR_EdR, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_RSM, &BX_CPU_C::RSM, NULL, BX_CPU_PENTIUM)
...
bx_define_opcode(BX_IA_SBB_EAXId, &BX_CPU_C::SBB_EAXId, NULL, BX_CPU_386)
...
bx_define_opcode(BX_IA_SBB_EdGdM, &BX_CPU_C::SBB_EdGdM, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_SBB_EdIdM, &BX_CPU_C::SBB_EdIdM, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_SBB_EdIdR, &BX_CPU_C::SBB_EdIdR, NULL, BX_CPU_386)
...
bx_define_opcode(BX_IA_SBB_GdEdM, &BX_CPU_C::LOAD_Ed, &BX_CPU_C::SBB_GdEdR, BX_CPU_386)
bx_define_opcode(BX_IA_SBB_GdEdR, &BX_CPU_C::SBB_GdEdR, NULL, BX_CPU_386)
...
bx_define_opcode(BX_IA_SETB_EbM, &BX_CPU_C::SETB_EbM, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_SETB_EbR, &BX_CPU_C::SETB_EbR, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_SETBE_EbM, &BX_CPU_C::SETBE_EbM, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_SETBE_EbR, &BX_CPU_C::SETBE_EbR, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_SETL_EbM, &BX_CPU_C::SETL_EbM, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_SETL_EbR, &BX_CPU_C::SETL_EbR, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_SETLE_EbM, &BX_CPU_C::SETLE_EbM, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_SETLE_EbR, &BX_CPU_C::SETLE_EbR, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_SETNB_EbM, &BX_CPU_C::SETNB_EbM, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_SETNB_EbR, &BX_CPU_C::SETNB_EbR, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_SETNBE_EbM, &BX_CPU_C::SETNBE_EbM, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_SETNBE_EbR, &BX_CPU_C::SETNBE_EbR, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_SETNL_EbM, &BX_CPU_C::SETNL_EbM, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_SETNL_EbR, &BX_CPU_C::SETNL_EbR, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_SETNLE_EbM, &BX_CPU_C::SETNLE_EbM, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_SETNLE_EbR, &BX_CPU_C::SETNLE_EbR, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_SETNO_EbM, &BX_CPU_C::SETNO_EbM, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_SETNO_EbR, &BX_CPU_C::SETNO_EbR, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_SETNP_EbM, &BX_CPU_C::SETNP_EbM, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_SETNP_EbR, &BX_CPU_C::SETNP_EbR, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_SETNS_EbM, &BX_CPU_C::SETNS_EbM, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_SETNS_EbR, &BX_CPU_C::SETNS_EbR, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_SETNZ_EbM, &BX_CPU_C::SETNZ_EbM, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_SETNZ_EbR, &BX_CPU_C::SETNZ_EbR, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_SETO_EbM, &BX_CPU_C::SETO_EbM, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_SETO_EbR, &BX_CPU_C::SETO_EbR, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_SETP_EbM, &BX_CPU_C::SETP_EbM, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_SETP_EbR, &BX_CPU_C::SETP_EbR, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_SETS_EbM, &BX_CPU_C::SETS_EbM, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_SETS_EbR, &BX_CPU_C::SETS_EbR, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_SETZ_EbM, &BX_CPU_C::SETZ_EbM, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_SETZ_EbR, &BX_CPU_C::SETZ_EbR, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_SGDT_Ms, &BX_CPU_C::SGDT_Ms, NULL, BX_CPU_286)
...
bx_define_opcode(BX_IA_SHLD_EdGdR, &BX_CPU_C::SHLD_EdGdR, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_SHLD_EdGdM, &BX_CPU_C::SHLD_EdGdM, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_SHLD_EwGwR, &BX_CPU_C::SHLD_EwGwR, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_SHLD_EwGwM, &BX_CPU_C::SHLD_EwGwM, NULL, BX_CPU_386)
...
bx_define_opcode(BX_IA_SHRD_EdGdR, &BX_CPU_C::SHRD_EdGdR, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_SHRD_EdGdM, &BX_CPU_C::SHRD_EdGdM, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_SHRD_EwGwR, &BX_CPU_C::SHRD_EwGwR, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_SHRD_EwGwM, &BX_CPU_C::SHRD_EwGwM, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_SIDT_Ms, &BX_CPU_C::SIDT_Ms, NULL, BX_CPU_286)
bx_define_opcode(BX_IA_SLDT_Ew, &BX_CPU_C::SLDT_Ew, NULL, BX_CPU_286)
bx_define_opcode(BX_IA_SMSW_EwR, &BX_CPU_C::SMSW_EwR, NULL, BX_CPU_286)
bx_define_opcode(BX_IA_SMSW_EwM, &BX_CPU_C::SMSW_EwM, NULL, BX_CPU_286)
...
bx_define_opcode(BX_IA_STR_Ew, &BX_CPU_C::STR_Ew, NULL, BX_CPU_286)
bx_define_opcode(BX_IA_SUB_ALIb, &BX_CPU_C::SUB_ALIb, NULL, 0)
bx_define_opcode(BX_IA_SUB_AXIw, &BX_CPU_C::SUB_AXIw, NULL, 0)
bx_define_opcode(BX_IA_SUB_EAXId, &BX_CPU_C::SUB_EAXId, NULL, BX_CPU_386)
...
bx_define_opcode(BX_IA_SUB_EdGdM, &BX_CPU_C::SUB_EdGdM, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_SUB_EdIdM, &BX_CPU_C::SUB_EdIdM, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_SUB_EdIdR, &BX_CPU_C::SUB_EdIdR, NULL, BX_CPU_386)
...
bx_define_opcode(BX_IA_SUB_GdEdM, &BX_CPU_C::LOAD_Ed, &BX_CPU_C::SUB_GdEdR, BX_CPU_386)
bx_define_opcode(BX_IA_SUB_GdEdR, &BX_CPU_C::SUB_GdEdR, NULL, BX_CPU_386)
...
bx_define_opcode(BX_IA_TEST_EAXId, &BX_CPU_C::TEST_EAXId, NULL, BX_CPU_386)
...
bx_define_opcode(BX_IA_TEST_EdGdM, &BX_CPU_C::LOAD_Ed, &BX_CPU_C::TEST_EdGdR, BX_CPU_386)
bx_define_opcode(BX_IA_TEST_EdGdR, &BX_CPU_C::TEST_EdGdR, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_TEST_EdIdM, &BX_CPU_C::LOAD_Ed, &BX_CPU_C::TEST_EdIdR, BX_CPU_386)
bx_define_opcode(BX_IA_TEST_EdIdR, &BX_CPU_C::TEST_EdIdR, NULL, BX_CPU_386)
...
bx_define_opcode(BX_IA_VERR_Ew, &BX_CPU_C::VERR_Ew, NULL, BX_CPU_286)
bx_define_opcode(BX_IA_VERW_Ew, &BX_CPU_C::VERW_Ew, NULL, BX_CPU_286)
bx_define_opcode(BX_IA_XCHG_EbGbM, &BX_CPU_C::XCHG_EbGbM, NULL, 0)
bx_define_opcode(BX_IA_XCHG_EbGbR, &BX_CPU_C::XCHG_EbGbR, NULL, 0)
bx_define_opcode(BX_IA_XCHG_EdGdM, &BX_CPU_C::XCHG_EdGdM, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_XCHG_EdGdR, &BX_CPU_C::XCHG_EdGdR, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_XCHG_ERXEAX, &BX_CPU_C::XCHG_ERXEAX, NULL, BX_CPU_386)
...
bx_define_opcode(BX_IA_XOR_EAXId, &BX_CPU_C::XOR_EAXId, NULL, BX_CPU_386)
...
bx_define_opcode(BX_IA_XOR_EdGdM, &BX_CPU_C::XOR_EdGdM, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_XOR_EdIdM, &BX_CPU_C::XOR_EdIdM, NULL, BX_CPU_386)
bx_define_opcode(BX_IA_XOR_EdIdR, &BX_CPU_C::XOR_EdIdR, NULL, BX_CPU_386)
...
bx_define_opcode(BX_IA_XOR_GdEdM, &BX_CPU_C::LOAD_Ed, &BX_CPU_C::XOR_GdEdR, BX_CPU_386)
bx_define_opcode(BX_IA_XOR_GdEdR, &BX_CPU_C::XOR_GdEdR, NULL, BX_CPU_386)
