...
void bx_instr_lin_access(unsigned cpu, bx_address lin, Bit32u phy, unsigned len, unsigned rw);
...
#  define BX_INSTR_PHY_WRITE(cpu_id, addr, len, data) bx_instr_phy_write(cpu_id, addr, len, data)
